...
ctcf_peaks <- import("/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/CTCF_chipseq_combined_peaks.narrowPeak")
...
# Writting out .saf
write.table(ctcf_saf, "/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/ctcf_peaks_combined.saf", sep = "\t", quote = F, row.names = F)
```
...
ctcf_bams <- list.files("/scratch/Shares/rinn/JR/rchip/analysis/03_diff_peaks/data/BAM_files/ctcf", full.names = T)
...
ctcf_feature_counts <- featureCounts(files = ctcf_bams,
                                     annot.ext = "/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/ctcf_peaks_combined.saf",
                                     isPairedEnd = TRUE,
                                     nthreads = 6)
# saving
write_rds(ctcf_feature_counts, "/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/CTCF_feature_counts_output.rds")
```
...
save(ctcf_feature_counts, ctcf_saf, file = "/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/minimal_env_object.RData")
# load in 
load("/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/minimal_env_object.RData", verbose = T)
```
...
ggplot(rnase_res, aes(x = log2FoldChange, y = -log10(pvalue))) +
  geom_point()
# saving
ggsave("/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/chip_plus_minus_rnase_volcano.pdf")
```
...
ggplot(chip_input_res, aes(x = log2FoldChange, y = -log10(pvalue))) +
  geom_point()
# saving
ggsave("/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/chip_input_volcano.pdf")
```
...
ggplot(wash_rnase_res, aes(x = log2FoldChange, y = -log10(pvalue))) +
  geom_point()
# saving
ggsave("/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/wash_rnase_volcano.pdf")
```
...
theme_paperwhite()
ggsave("/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/CTCF_rchip_result.pdf")
```
...
ggsave("/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/wash_rnase_vs_chip.pdf")
```
...
ggplot(chip_wash_rnase_data, aes(x = l2fc_chip_vs_input, y = l2fc_wash_rnase_vs_input)) +
  ...
  xlim(-3,3) +
  ylim(-3,3)
ggsave("/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/CTCF_all_reps_wash_RNase.pdf")
```
...
ggsave("/scratch/Shares/rinn/tenaya/rChIP/rChIP/2023_02_23_CTCFfromJun2022/cleaner_all_ctcf replicates.pdf")
```
