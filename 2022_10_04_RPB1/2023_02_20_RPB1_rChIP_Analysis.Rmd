...
pe_bams <- c(paste0(base_path, "RPB1_NoR_R1.mLb.clN.sorted.bam"), paste0(base_path, "RPB1_NoR_R2.mLb.clN.sorted.bam"), paste0(base_path, "RPB1_Rnase_R1.mLb.clN.sorted.bam"), paste0(base_path, "RPB1_Rnase_R1.mLb.clN.sorted.bam"))
...
ggplot(counts_df, aes(x = log10(RPB1_NoR_R1.mLb.clN.sorted.bam), 
                      y = log10(RPB1_Rnase_R1.mLb.clN.sorted.bam))) +
  geom_point()
counts_df <- counts_df %>%
  mutate(unnormalized_ratio = log2(RPB1_NoR_R1.mLb.clN.sorted.bam / RPB1_Rnase_R1.mLb.clN.sorted.bam)) %>%
