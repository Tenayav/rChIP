...
ggplot(counts_df, aes(x = log2(RPB1.NoR.R1.mLb.clN.sorted.bam), 
                      y = log2(RPB1.Rnase.R1.mLb.clN.sorted.bam))) +
  geom_point()
...
#Working on generating the Fold Change Log 2 (ChIP/Input) with +Rnase on Yaxis and NoRnase on xaxis